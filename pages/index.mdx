      ...
      <main className="flex-1">
        ...
        >
          <div className="bg-slate-900/50 backdrop-brightness-50">
            <div className="container mx-auto px-4 py-12 md:pb-16 xl:pb-20 font-mono xl:text-2xl md:text-xl xl:leading-loose md:leading-relaxed space-y-4">
              <h1 className="font-dune xl:text-6xl lg:text-5xl md:text-4xl text-2xl font-bold tracking-widest mb-8">
                Likecat.cn
              </h1>
              {props.children}
        ...
        <div className="container mx-auto px-4 my-8 md:text-xl xl:text-3xl">
          <h2 className="font-dune font-bold mb-4">Things I interested</h2>
