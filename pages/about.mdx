        ...
        <div className="py-4 md:py-12 space-y-4">
          <div className="flex space-x-4 md:hidden">
            ...
            <div className="my-auto font-mono">
              <h2 className="font-dune font-bold text-lg">Bojun Zhang</h2>
              <p>
          ...
          <h1 className="font-dune xl:text-6xl lg:text-5xl md:text-4xl text-2xl font-bold tracking-widest">
            About Me
          </h1>
          <Image
            src="/Display.jpg"
          ...
          />
          <div className="font-mono xl:text-2xl md:text-xl xl:leading-loose md:leading-relaxed space-y-4">
            {props.children}
          </div>
        </div>
      </main>
