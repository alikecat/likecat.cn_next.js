  ...
  return (
    <div>
      ...
      <main className="container m-auto px-4 flex md:space-x-8">
        <SideBar />
        <div className="md:py-12 space-y-4">
          <div className="flex my-4 space-x-4 md:hidden">
            <Image
              src="/Avatar.jpg"
              alt=""
              width={96}
          ...
          />
          <div className="font-sans xl:text-2xl md:text-xl xl:leading-loose md:leading-relaxed space-y-4">{props.children}</div>
        </div>
      </main>
      <footer>
        <FootBar />
