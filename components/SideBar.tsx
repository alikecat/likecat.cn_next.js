...
export function SideBar() {
  return (
    <div className="basis-72 max-md:hidden flex flex-col py-4 space-y-4 font-mono">
      <Image
        src="/Avatar.jpg"
        alt=""
        width={256}
        height={256}
        quality={100}
        className="rounded-full outline outline-1 outline-offset-8 outline-white/20"
      ></Image>
      <h2 className="font-serif font-bold text-2xl text-center">Bojun Zhang</h2>
      <p>
        Mechanical PhD candidate, tackling gears by day, moonlighting as a code
        wizard and UI designer by night. 🚀💻✨
      </p>
      <div className="table leading-loose border-t border-white/20 py-4">
        ...
        <div className="table-row">
          <FontAwesomeIcon icon={faLocationDot} className="table-cell m-auto" />
